...
def get_txt(AudioFile):
    print("正在识别语音")
    # 测试时候在此处正确填写相关信息即可运行
    global wsParam
    wsParam = Ws_Param(APPID='05f30604', APISecret='MjEwY2ZmMTIwYTNjNzZhMTNkZGRlN2Ni',
                       APIKey='e606a52757e133ca2a066c24533fc30b',
                       AudioFile=AudioFile)
