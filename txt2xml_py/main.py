...
os.environ['ASR_DIR'] = r"F:\SY_files\硕士_xml_提示词工程\code_file\txt2xml_v2\txt2xml_py\audio2txt"

from tool import action_classifier, get_info, name_standardizer, json2xml
# from xf_audio2txt import get_txt_from_audio
...
if __name__ == '__main__':
    dest_html_file = r'F:\SY_files\硕士_xml_提示词工程\code_file\txt2xml_v2\xml_file\test_v2.html'
    while True:
        ...
        json2xml.modify_xml(std_info_json, dest_html_file)
        print("命令已执行。")
        print(
            "========================================================================================================")
